...
def query_page():
    ...
    if st.button("Invia"):
        ...
        prompt = ChatPromptTemplate.from_template("Sei un assistente preciso e attento. Rispondi a questa domanda in italiano: {question}.Ner rispondere tieni conto di queste informazioni {context}. Inoltre, inizia dando una risposta secca e coincisa indivduando il centro della questione poi espndi la tua risposta con esempi. Gli esempi possono essere inventati do dati da le informazioni del constesto. Specifica quando sono esempi inventati. Rispondi in italiano a meno che non ti si viene chiesto diversamento")
