...
def open_question():
    ...
    db_path = "db"  # Modifica del percorso del database
    ...
    if "last_question" in st.session_state and st.session_state.last_question:
        ...
        if st.button("Valuta Risposta"):
            ...
            evaluation_prompt = ChatPromptTemplate.from_messages([
                ...
                Alla fine dai spunti per approfondimenti e metti la fonte su cui hai creato la proposta di risposta. Rivolgiti sempre a chi scrive la risposta come studente.""")
            ])
